                            ...
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        ...
                                        <form class="form" action="{{route('admin.acounts.storetbalance')}}"
                                            ...
                                            <div class="form-body">
                                                ...
                                                <h4 class="form-section"><i class="ft-home"></i>بيانات رصيد الخزنه </h4>
                                                <div class="row">

                                                    <div class="col-lg-12">
                                                        <div class="form-group">

                                                            <label for="projectinput1"> رصيد الخزنه </label>

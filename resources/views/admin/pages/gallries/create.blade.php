                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{route('admin.gallary.create')}}">أضافة معرض صوره </a>
                                </li>
                                <li class="breadcrumb-item active">معرض الصوره
                                </li>
                            </ol>
                        </div>
                    </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        ...
                                        <form class="form" action="{{route('admin.gallary.store')}}"
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                            <label for="projectinput1"> القسم - {{__('messages.ar')}} </label>

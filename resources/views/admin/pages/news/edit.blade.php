                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">تعديل الاخبار
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form"> تعديل  الاخبار  </h4>
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form"
                                              action="{{route('admin.newes.update',$news -> id)}}"
                                              method="POST"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" value="{{$news->title_ar}}" id="name"
                                                               class="form-control"
                                                               placeholder="  "
                                                               name="title_ar">
                                                        @error("title_ar")
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" value="{{$news->title_en}}" id="name"
                                                               class="form-control"
                                                               placeholder="  "
                                                               name="title_en">
                                                        @error("title_en")
                                                ...
                                                <div class="col-lg-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <textarea id="froala-editor"
                                                                  class="form-control"
                                                                  value="{{$news->text_ar}}"placeholder="  "
                                                                  name="text_ar">{{$news->text_ar}} </textarea>
                                                        @error("text_ar")
                                                        <span class="text-danger"> هذا الحقل مطلوب</span>
                                                        @enderror
                                                    </div>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea id="froala-editor"
                                                                  ...
                                                                  value=""
                                                                  placeholder="  "
                                                                  name="text_en"> {{$news->text_en}}</textarea>
                                                        @error("text_en")
                                                        <span class="text-danger"> هذا الحقل مطلوب</span>
                                                        @enderror
                                                    </div>

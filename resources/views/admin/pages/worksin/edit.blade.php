                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href=""> من نحن  </a>
                                </li>
                                <li class="breadcrumb-item active">تعديل من نحن
                                </li>
                            </ol>
                        </div>
                    </div>
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form"
                                            ...
                                            @csrf
                                            <input name="id" value="{{$abouts -> id}}" type="hidden">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" value="{{$abouts->title_ar}}" id="name"
                                                               class="form-control"
                                                               placeholder="  "
                                                               name="title_ar">
                                                        @error("title_ar")
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" value="{{$abouts->title_en}}" id="name"
                                                               class="form-control"
                                                               placeholder="  "
                                                               name="title_en">
                                                        @error("title_en")
                                                ...
                                                <div class="col-lg-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <textarea id="froala-editor"
                                                                  class="form-control"
                                                                  value="{{$abouts->text_ar}}"placeholder="  "
                                                                  name="text_ar">{{$abouts->text_ar}} </textarea>
                                                        @error("text_ar")
                                                        <span class="text-danger"> هذا الحقل مطلوب</span>
                                                        @enderror
                                                    </div>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea id="froala-editor"
                                                                  ...
                                                                  value=""
                                                                  placeholder="  "
                                                                  name="text_en"> {{$abouts->text_en}}</textarea>
                                                        @error("text_en")
                                                        <span class="text-danger"> هذا الحقل مطلوب</span>
                                                        @enderror
                                                    </div>

...
<head>
    ...
    <link rel="apple-touch-icon" href="{{asset('back/images/Picture1.png')}}">
    <link rel="shortcut icon" type="image/x-icon" href="{{asset('back/images/Picture1.png')}}">
    <link
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('back/fonts/all.min.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('back/fonts/brands.min.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('back/fonts/fontawesome.min.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('back/fonts/regular.min.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('back/fonts/solid.min.css')}}">
...
<script src="{{asset('back/fonts/js/all.min.js')}}" type="text/javascript"></script>
<script src="{{asset('back/fonts/js/brands.min.js')}}" type="text/javascript"></script>
<script src="{{asset('back/fonts/js/fontawesome.min.js')}}" type="text/javascript"></script>
<script src="{{asset('back/fonts/js/regular.min.js')}}" type="text/javascript"></script>
<script src="{{asset('back/fonts/js/solid.min.js')}}" type="text/javascript"></script>
